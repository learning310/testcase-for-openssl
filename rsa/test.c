...
#define PUB_KEY_PATH \
	"/home/alansong/ssl/testcase-for-openssl/rsa/public_key.pem"
#define PRIV_KEY_PATH \
	"/home/alansong/ssl/testcase-for-openssl/rsa/private_key.pem"
#define MSG "abcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefgh"
...
unsigned char *rsa_encrypt(EVP_PKEY *pkey, const unsigned char *msg,
...
unsigned char *rsa_decrypt(EVP_PKEY *pkey, const unsigned char *encrypted,
...
int main()
{
	...
	unsigned char *encrypted = rsa_encrypt(pubkey, (unsigned char *)MSG,
	...
	unsigned char *decrypted =
		rsa_decrypt(privkey, encrypted, encrypted_len, &decrypted_len);
	printf("Decryption successful, decrypted message: %.*s\n",
